#This function returns a Data Frame of best or worst performing hositals together
#with the state where it is location for each outcome that has been identified.
